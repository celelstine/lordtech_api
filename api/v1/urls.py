...
router.register(r'airtime-recieved', AirtimeRecievedViewSet, base_name='airtime-recieved')
...
router.register(r'datasales-summary', DataSalesSummaryViewSet, base_name='datasales-summary')
router.register(r'sub', DataSubscriptionViewSet, base_name='sub')
router.register(r'salesrep-sub', SalesRepDataSubscriptionViewSet, base_name='salesrep-sub')
